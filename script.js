...
const disabledCountries = ["Western Sahara", "Afghanistan", "Iran"];
...
const mySelect = document.getElementById("country");
...
for (let key in countries) {
  ...
  option.setAttribute("value", countries[key].name);

  let optionText = document.createTextNode(countries[key].name);
...
// let optionText = document.createTextNode(countries[key]);
...
// const options=Array.from(mySelect.option)
// console.log(options)
// options.sort((a, b) => a.text.localeCompare(b.text));
// mySelect.innerHTML = ""; // Clear the existing options
// console.log(options)
